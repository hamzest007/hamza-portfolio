    ...
    <div className="min-h-screen bg-gray-900 text-white font-sans antialiased">
      <main className="max-w-7xl mx-auto px-6 py-16">
                ...
                <img
                  src={
                    typeof project.image === "string"
                      ? `/images/${project.image}` // used for public/images
                      : project.image // used for imported
                  }
                  alt={project.title}
        ...
        <section className="mt-20 text-center">
          ...
          <Link
            to="/contact"
            className="px-8 py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-medium rounded-lg transition duration-300"
          >
            Contact Me
          </Link>
        </section>
